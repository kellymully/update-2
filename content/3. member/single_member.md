---
title: "Single Member Registration Guide"
description: "Step by step instructions for adding a new individual member in Unit Master."
order: 1
---

**How to Add New Members, Group, or Institution**
**A single member** refers to an individual person who is registered as a member of the unit on their own.

Welcome to our **New Member Registration Guide**. This guide explains how to register three types of members in the system: **Single Members, Joint Members**, and **Institutional Members**. It is designed to be simple, clear, and easy to follow so that everyone, regardless of their experience, can start using the system without issues.
...
<img src="/images/side.png" alt="Agents sidebar" class="img-small"  width= "400px"/>
...
<img src="/images/single.png" alt="Agents sidebar" class="img-small"  width= "400px"/>
...
* Telephone No Enter the landline number (if available).
* Mobile Phone No Enter the mobile phone number.
* Email Address Enter a valid email address.
* Physical Address Enter the full physical address.
...
* Relationship Indicate the relationship (for example father, sister, spouse).
...
* Income Range Choose the member's income range.
...
Occupation Enter the current occupation or job title.
Employer Name Enter the name of the employer.
Employer Address / Details Provide address or contact details if required.
...
Fee Category Choose the applicable fee category.
Withdraw Dividends? Select Yes if dividends are paid out, or No if they are reinvested.
...
Review all information carefully before finishing. Correct data at onboarding stage reduces errors, rework and compliance issues later.
```
