 ...
 ***step 3. statutory details***
 ...
 <p>Statutory fields are used for compliance, tax, and regulatory reporting. Complete them carefully.
...
<p>Link the joint member to the appropriate fund, fee structure and servicing agent, and set account preferences.

![](/images/accjoin.png)

**1. Select Your Investment Fund**
```
*Use the Fund Name dropdown to choose the fund (for example Money Market Fund, Equity Fund, Bond Fund). Each fund has its own risk and return profile.
 ...
 **3. Assign an Agent**
 ```
 *Use the Agent Name dropdown to choose the advisor or agent who will manage the account. If there is no specific agent, select the default or branch agent.
 ```

 **4. Tax Display Preference**
 ```
 Show Tax on Statement? Select Yes if you want tax deductions displayed clearly on statements, or No if you prefer net figures only. Choosing Yes is recommended for transparency.
```
**5. Dividend Withdrawal Option**
```
Withdraw Dividends? Select Yes to receive cash payouts, or No to reinvest dividends automatically for compound growth.
```
...
After all required sections are completed, review the information carefully and then click the **Finish** or **Submit** button in the application.
```
Accurate data at onboarding reduces corrections, compliance issues, and processing delays later. Always confirm names, mandates, tax numbers, and bank details before submitting.
```
